...
export const STADIUMS = [
  {
    id: 'royal', name: 'الملعب الملكي', desc: 'نهار مشمس وجمهور غفير',
  ...
  {
    id: 'neon', name: 'ساحة النيون', desc: 'مباراة ليلية تحت الأضواء الكاشفة',
  ...
  {
    id: 'desert', name: 'واحة الغروب', desc: 'ملعب صحراوي عند غروب الشمس',
  ...
  {
    id: 'frozen', name: 'قمة الجليد', desc: 'ثلج يتساقط والكرة تنزلق أكثر',
  ...
  {
    id: 'rain', name: 'ملعب العاصفة', desc: 'أمطار غزيرة وبرق في السماء',
